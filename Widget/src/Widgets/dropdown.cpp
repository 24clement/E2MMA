...
Dropdown::Dropdown(lv_obj_t * display, int pos_x, int pos_y, int size_x, int size_y, bool hiden, const char * list, void (*f)(lv_event_t *, void *), void * arguments) : Widget(display, Widget::widgetType::Dropdown, pos_x, pos_y, size_x, size_y, hiden), list(list), callback(f ? f : Widget::default_func), arguments(arguments){
